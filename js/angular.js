 ...
 * SimplySocial.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://SimplySocial.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://SimplySocial.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * ```
 *  angular.module('SimplySocial', []).config(function($sceDelegateProvider) {
 ...
 *      'http://SimplySocial.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
 ...
 * <file name="index.html">
 *   <div ng-controller="SimplySocialController as myCtrl">
 ...
 *
 *   mySceApp.controller("SimplySocialController", function SimplySocialController($http, $templateCache, $sce) {
 *     var self = this;
 ...
 *
 * ```
 * angular.module('SimplySocialWithSceDisabledSimplySocial', []).config(function($sceProvider) {
